...
4. "Quit Claim Deed" : Justificatif de vente entre la société intermédiaire (LLC) et la Société (LLC Series ou C-Corp) détenant le bien, dont vous êtes actionnaire via le RealToken correspondant,
5. "Warranty Deed" : Justificatif de vente entre le vendeur initiale du bien et une société intermédiaire (LLC RealT),\
   \
