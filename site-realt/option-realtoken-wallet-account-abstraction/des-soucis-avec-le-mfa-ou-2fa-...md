...
* Sans cette protection :  votre authentification est stockée chez un prestataire (Web3Auth), certes de façon sécurisé mais vous êtes dépendant du prestataire.
...
Si vous avez activé le MFA et que l'application ne trouve pas le cookie correspondant sur votre navigateur, elle va vous afficher l'écran suivant "New device detected" :
...
Si vous avez activé le MFA, une information d'authentification réside sur votre appareil.

Si vous perdez votre appareil (ou que vous réinitialisez l'appareil ou le navigateur), vous devrez utiliser le Social login de récupération (cf chapitre précédent)

Si vous perdez le Social login de connexion à votre Realtoken Wallet, vous devrez demander au support RealT (bulle orange sur realt.co) une réinitialisation de votre accès à votre Realtoken Wallet.

Si vous perdez le Social login de récupération ou qu'il ne fonctionne pas vous devrez acccéder à la fonction "Paramètres MFA" décrite dans le chapitre suivant.
