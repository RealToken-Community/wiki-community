...
1.  Se connecter avec son wallet, en étant sur la chaine source (Ethereum, par ex),
    ...
    <figure><img src="../../.gitbook/assets/image (33).png" alt="" width="211"><figcaption></figcaption></figure>
2.  Sélectionner la propriété de votre wallet que vous souhaitez transférer :\
    ...
    <figure><img src="../../.gitbook/assets/image (34).png" alt="" width="168"><figcaption></figcaption></figure>
...
5.  Transférer, en validant la transaction avec les frais correspondants (à votre charge).
    ...
    <figure><img src="../../.gitbook/assets/image (38).png" alt="" width="327"><figcaption></figcaption></figure>
6.  Un message confirme l'envoi sur la chaine source (avec les coordonnées de la transaction correspondante) :

    <figure><img src="../../.gitbook/assets/image (57).png" alt="" width="216"><figcaption></figcaption></figure>
