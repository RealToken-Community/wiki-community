...
<figure><img src="../.gitbook/assets/image (1) (1) (1).png" alt="" width="361"><figcaption><p>Exemple de plafond "illimité" par défaut</p></figcaption></figure>
...
1.  **Approuver en l’état**, sans modification du montant.
    ...
    <figure><img src="../.gitbook/assets/image (2) (1).png" alt=""><figcaption><p>Autorisation du wallet via Revoke.cash</p></figcaption></figure>
2.  **Cliquer sur « max »**,
